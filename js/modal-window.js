...
(function() {
  ...
  function buildOut() {
    ...
    if (this.options.closeButton === true) {
      ...
      this.closeButton.className = "js-modal-close close-button";
    ...
    if (this.options.overlay === true) {
      ...
      this.overlay.className = "js-modal-overlay " + this.options.className;
      docFrag.appendChild(this.overlay);
    }

    // Create content area and append to modal
    contentHolder = document.createElement("div");
    contentHolder.className = "js-modal-content";
